import { QuestionActionKind, QuestionState } from './../reducers/add-questions-reducer';
...
const useEditQuestionReducer = (iniliazedState: QuestionState) => {
...
export default useEditQuestionReducer;